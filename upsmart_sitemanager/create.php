...
EOHTML;
	...
	function upsmart_page_create_business_basic($post) {
		...
		$post->post_content .= <<<EOHTML
		<span class='subheading'>We'd like to know more about you and your company. Just fill out the fields below (everything is required).</span>
		<h3>Basic Info</h3>
EOHTML;
	...
	function upsmart_page_create_business_people($post) {
		...
		$post->post_content .= <<<EOHTML
		<div class= 'subheading'>We'd like to know more about you and your company. Just fill out the fields below (everything is required).
...
EOHTML;
	...
	function upsmart_page_create_milestones($post) {
		...
		$post->post_content = upsmart_page_create_nav(3,5).'<h2>Business Information</h2>';
		...
		$post->post_content .= <<<EOHTML
		We'd like to know more about you and your company. Just fill out the fields below.
...
EOHTML;
	...
	function upsmart_page_create_products($post) {
		...
		$post->post_content = upsmart_page_create_nav(3,4).'<span class=subheading><h2>Business Information</h2></span>';
...
EOHTML;
	...
	function upsmart_page_create_financial_applicant($post) {
		...
		$post->post_content .= <<<EOHTML
		<div class= 'subheading'>We'd like to know more about you and your company. Just fill out the fields below (everything is required).</div>
		<h3>Overview</h3>
EOHTML;
